...
if __name__ == "__main__":
    ...
    problem = ProblemSIRV(p=lambda t: 0.1 if 6 <= t <= 15 else 0, beta=.0001,
    ...
    problem_true = ProblemSIRV(p=lambda t: 0.1 if 6 <= t <= 15 else 0, beta=.0001,
    nu=0.1, S0=1500, I0=1, R0=0, V0=0, T=60)
    solver_true = AdamsB(problem_true)
